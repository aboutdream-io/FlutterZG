...
class NewPostBloc extends BlocBase {
  NewPostBloc(this._repository, this._myLocalization);

  final PostRepository _repository;
  final MyLocalization _myLocalization;
  BehaviorSubject<NewPostState> _stateController = BehaviorSubject<NewPostState>.seeded(NewPostState(stateType: StateType.waiting));
