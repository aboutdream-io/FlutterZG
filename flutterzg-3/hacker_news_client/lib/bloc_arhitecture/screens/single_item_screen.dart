...
import 'package:hacker_news_client/bloc_arhitecture/widgets/comment_item.dart';
...
class _SingleStoryState extends State<SingleStoryScreen> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    if(_bloc == null){
      ...
      _bloc.getNewsItem(newsId: widget.itemId);
    }

    return StreamBuilder<Item>(
      stream: _bloc.newsDetails,
      builder: (BuildContext context, AsyncSnapshot<Item> snapshot){
        if(snapshot.hasData){
          ...
          return Scaffold(
            ...
            body: _buildLinkStory(context, snapshot.data),//_showWebView(snapshot.data),
