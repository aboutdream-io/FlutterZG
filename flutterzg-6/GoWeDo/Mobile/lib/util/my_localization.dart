...
class MyLocalization extends DefaultMaterialLocalizations {
  ...
  String get passwordLengthError => Intl.message('Password should be at least 6 characters long', name: 'passwordLengthError');
  ...
  String get registerSuccess => Intl.message('You have successfully created GoWeDo account, '
    'you can log in with your credentials', name: 'registerSuccess');
}
